...
const PAYROLL_VARIABLES = [
  ...
  { key: "tienLe", name: "Tiền lễ" },
  { key: "luongLe", name: "Lương lễ" },
  { key: "ngayCongLe", name: "Công ngày lễ" },
  { key: "soNgayLe", name: "Số ngày lễ" },
  { key: "heSoLe", name: "Hệ số lễ" },
  { key: "tienLeCoDinh", name: "Tiền lễ cố định" },
  { key: "thuong", name: "Thưởng" },
