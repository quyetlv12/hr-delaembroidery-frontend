...
const payrollFormulaLabels: Array<[PayrollEmployeeViewColumn, string]> = [
  ...
  ["overtimeTotal", "(17)"],
  ["bonusTotal", "(18)=lễ*hệ số"],
  ["grossSalary", "(19)=(16)+(17)+(18)"],
  ["employerInsuranceTotal", "(20)"],
  ["insuranceTotal", "(21)"],
  ["taxTotal", "(22)"],
  ["advanceTotal", "(23)"],
  ["deductionTotal", "(24)=(21)+(22)+(23)"],
  ["bonus", "(25)"],
  ["netSalary", "(26)=(19)-(24)+(25)"],
  ["dependentNote", "(27)"],
  ["email", "(28)"],
  ["status", "(29)"],
];
...
const inputColumnVariables: Partial<Record<PayrollEmployeeViewColumn, string[]>> = {
  ...
  bonusTotal: ["ngayCongLe", "soNgayLe", "heSoLe", "tienLeCoDinh"],
  bonus: ["thuong"],
};
...
const payrollVariableNames: Record<string, string> = {
  ...
  luongLe: "Lương lễ",
  soNgayLe: "Số ngày lễ",
  ngayCongLe: "Công ngày lễ",
  heSoLe: "Hệ số lễ",
  tienLeCoDinh: "Tiền lễ cố định",
  thuongLeCoDinh: "Thưởng lễ cố định",
  tienThuong: "Tiền thưởng",
  thuongThang: "Thưởng tháng",
